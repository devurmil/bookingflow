        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-6 relative overflow-hidden">
            ...
            >
                <div className="glass-card p-12 rounded-[3rem] border border-rose-500/20 shadow-2xl relative overflow-hidden">
                    ...
                    <h1 className="text-4xl font-black text-slate-900 dark:text-white mb-4 tracking-tight">Access <span className="text-rose-500">Restricted</span></h1>
                ...
                <div className="mt-8 flex justify-center items-center gap-3 opacity-40 dark:opacity-20">
                    <ShieldAlert className="w-4 h-4 text-rose-500" />
                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-900 dark:text-white">Security Protocol 403-B ACTIVE</span>
                </div>
            </motion.div>
        </div>
    );
